...
class MallProductOrderLog extends Model
{
    protected $name='mall_product_order_log';
    ...
    public function getLogListAttr($value,$data)
    {
        if (empty($data['log_id'])){
            ...
            return db('mall_product_order_log')->field('log_id',true)->where('log_id',$data['log_id'])->order('id desc')->select();
        }
    }
