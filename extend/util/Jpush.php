...
class Jpush {
	private $app_key = '4a9780b14647d477a300a514'; // 待发送的应用程序(appKey)，只能填一个。
	private $master_secret = '698a3cbfa6cf450289dbadf7'; // 主密码
	...
	public function push($receiver = 'all', $content = '', $platform = 'ios',$title,$m_time = '86400', $m_type = '', $m_txt = '') {
